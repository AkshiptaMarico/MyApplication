...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private void toFetchData() {
        try {
            ...
            Utility.showLoadingDialog(ProductDetailsActivity.this, "", " Please wait ... ");
            ApiRequest.getInstance(ProductDetailsActivity.this).addToRequestQueue(
                    RequestBuilder.toFetchVehiclesDetailById(
                            ...
                            new Response.Listener<CommonResponse>() {
                                ...
                                public void onResponse(CommonResponse response) {
                                    try {
                                        if (!response.STATUS.trim().toUpperCase().equals(ProductDetailsActivity.this.getResources().getString(R.string.str_success_uppercase))) {
                                            Utility.toCallToast((response.REASON != null && response.REASON.length() > 0) ? response.REASON : ProductDetailsActivity.this.getResources().getString(R.string.str_invalid_data), ProductDetailsActivity.this);
                                        } else {
                                            if (response.DATA != null) {
                                                ...
                                                Utility.toCallToast(getString(R.string.str_no_information_found), ProductDetailsActivity.this);
                                            }
                                        }
                                        Utility.dismissLoadingDialog();
                                    } catch (Exception | Error e) {
                                        Utility.toCallToast(ProductDetailsActivity.this.getResources().getString(R.string.str_invalid_data) + "\nError: " + e.getMessage(), ProductDetailsActivity.this);
                                        Utility.dismissLoadingDialog();
                                        e.printStackTrace();
                                    }
                                }
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    try {
                                        Utility.toCallToast(ProductDetailsActivity.this.getResources().getString(R.string.str_invalid_data)
                                                + "\nError : " + error.getMessage(), ProductDetailsActivity.this);
                                        Utility.dismissLoadingDialog();
            ...
            Utility.toCallToast(ProductDetailsActivity.this.getResources().getString(R.string.str_invalid_data), ProductDetailsActivity.this);
            Utility.dismissLoadingDialog();
            e.printStackTrace();
        }
    }
